//-- Esta estrutura utiliza o plugin Cropit.js  ** Mario 15/06/2018 **
//-- Caso seja alterada, verificar de carregar junto a ela os arquivos:
//-- jquery.cropit.js e cropit.custom.css
let ImageBase64;
let Method_UserAvatar = () => {
    ...
    function ConstroiTela(){
        ...
        let html = '<div id="corpoCropit" class="image-editor">'
            ...
            html += '   <tr>'
            html += '     <td colspan="5" style="padding-bottom:20px;" align="center"><div class="cropit-preview"></div></td>'
            html += '   </tr>'
            html += '   <tr>'
            html += '     <td colspan="5" style="padding-bottom:2%; padding-left:5px;">Redimencionar imagem</td>'
            html += '   </tr>'
            html += '   <tr>'
            html += '     <td align="center"><i id="rotate-ccw" class="rotate fas fa-undo-alt"></i></td>'
            html += '     <td align="center"><i id="rotate-cw" class="rotate fas fa-redo-alt"></i></td>'
            html += '     <td align="center"><span class="icone-imagem fas fa-search-minus"></span></td>'
            html += '     <td align="center"><input type="range" class="cropit-image-zoom-input custom" min="0" max="1" step="0.01"></td>'
            html += '     <td align="center"><span style="margin-left:5px;" class="icone-imagem fas fa-search-plus"></span></td>'
            html += '   </tr>'
            html += '   <tr>'
            html += '     <td colspan="5" style="padding-top:10px;" align="center">'
            html += '       <div class="container-fluid" style="float:right;">'
            html += '           <div class="row">'
            html += '             <div class="col-md-12">'
            html += '               <span id="selectArquivo" class="btn btn-primary" type="button"><span class="glyphicon glyphicon-picture"></span> Selecionar nova imagem</span>'
            html += '               <span id="aplicarAvatar" class="btn btn-warning" type="button"><span class="glyphicon glyphicon-check"></span> Aplicar/Visualizar</span>'
            html += '               <span id="salvaAvatar" class="btn btn-success" type="button"><span class="glyphicon glyphicon-floppy-saved"></span> Salvar</span>'
            html += '             </div>'
            html += '         </div>'
            html += '     </div>'
            html += '       <input id="uploadImagem" type="file" class="cropit-image-input input-hidden" accept="image/*">'
            html += '     </td>'
            html += '   </tr>'
            html += ' </table>'
            html += '</div>'
        ...
        $('#aplicarAvatar').click(function(event) {
            ...
            setTimeout(function() {
              ...
              let   divPrev ='<div align="center" style="display: block;">';
                    divPrev +=' <img align="middle" src="'+ imageData + '" id="previlPerfil1" alt="Prévia do perfil" class="previa-avatar-quadrado"/>';
                    divPrev +=' <img style="margin-top:10px;" align="middle" src="'+ imageData + '" id="previlPerfil2" alt="Prévia do perfil" class="previa-avatar-redondo"/>';
                    divPrev +='</div>';
    ...
    return {
        ...
        SelectImagem : function() {
          document.getElementById('uploadImagem').click();
          $("#uploadImagem").trigger('click');
        },

        AplicarVisualizar : function() {
